...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        ImageIcon i1 = null;
        try {
            i1 = new ImageIcon(ClassLoader.getSystemResource("icon/signupImage.png"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            try{
                Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/ebs", "root", "root");
                String str = null;
